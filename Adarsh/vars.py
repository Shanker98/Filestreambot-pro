...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '172.30.1.23'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '172.30.1.23:9090')) if not ON_HEROKU or getenv('FQDN', '172.30.1.23:9090') else APP_NAME+'.herokuapp.com'
